...
function KeywordCard({ icon, title, keywords, delay, isVisible }: { 
  icon: string,
  title: string, 
  keywords: string[],
  delay: number, 
...
export default function EngineOverview() {
  ...
  const features = [
    ...
    },
    {
      ...
      keywords: ["Custom Shocks", "Volatility Index", "Interest Rates", "Money Supply"]
    },
    {
      icon: "🔬",
      title: "Advanced Analytics",
      keywords: ["Stress Testing", "Risk Analysis", "Synthetic Data", "Real-World Dynamics"]
    }
  ];
    ...
    <div className="relative bg-gradient-to-br from-white via-purple-50 to-white py-20 px-8 lg:px-16 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 opacity-15">
          ...
          <div className="absolute top-40 right-20 w-96 h-96 bg-indigo-400 rounded-full mix-blend-multiply filter blur-xl animate-pulse" style={{ animationDelay: '2s' }}></div>
          <div className="absolute bottom-20 left-1/2 w-64 h-64 bg-pink-400 rounded-full mix-blend-multiply filter blur-xl animate-pulse" style={{ animationDelay: '4s' }}></div>
        </div>
