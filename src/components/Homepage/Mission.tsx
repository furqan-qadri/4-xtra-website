...
function DiagonalSection({
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute ${
          isLeft ? "-left-20 lg:-left-40" : "-right-20 lg:-right-40"
        } top-0 w-full h-full ${colorGradient} opacity-10`}
        style={{
          clipPath: isLeft
      ...
      <div
        className={`relative z-10 p-6 lg:p-8 ${
          isLeft ? "pl-0 lg:pl-6 text-left" : "pl-6 lg:pl-12 text-right"
        }`}
      >
        <h3
          className={`text-3xl lg:text-5xl font-black ${textColor} mb-4 tracking-tight leading-tight`}
        >
          {title}
        </h3>
        <p
          className={`text-gray-700 text-lg lg:text-xl leading-relaxed max-w-md ${
            isLeft ? "" : "ml-auto"
          }`}
        >
          {description}
        ...
        {/* Accent line */}
        <div
          className={`mt-6 h-1 w-20 ${colorGradient} rounded-full ${
            isLeft ? "" : "ml-auto"
          }`}
        />
      </div>
  ...
  return (
    <section id="mission-section" className="relative overflow-hidden pb-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-8">
        ...
        <div
          className={`text-center mb-12 transition-all duration-1500 delay-500 ${
        ...
        >
          <div className="relative max-w-5xl mx-auto">
            ...
            <p className="relative text-2xl lg:text-4xl text-gray-800 font-light leading-relaxed py-8 px-8">
              Empower every decision-maker in{" "}
              <span className="font-bold text-purple-700">
                Alternative Assets
              </span>{" "}
              to better anticipate the impacts of{" "}
              <span className="font-bold text-primary-900">
                macro-level shock events
              </span>{" "}
